...
class PositionalEncoding2D(nn.Module):
    ...
    def __init__(self, d_model, cyclic_peptide, minpos=-32, maxpos=32, p_drop=0.1):
    ...
    def forward(self, x, idx):
        ...
        print(f"The cyclic option is : {self.cyclic_peptide}")
        if self.cyclic_peptide:
...
class MSA_emb(nn.Module):
    ...
    def __init__(
        ...
        self.pos = PositionalEncoding2D(
            ...
            maxpos=maxpos,
            p_drop=p_drop,
            cyclic_peptide=self.cyclic_peptide,
        )
